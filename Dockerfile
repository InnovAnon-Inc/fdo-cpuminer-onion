...
# FDO
ENV   CFLAGS="-fipa-profile -fprofile-reorder-functions -fvpt -fprofile-abs-path -fprofile-arcs -fauto-profile=/var/cpuminer  $CFLAGS"
ENV  LDFLAGS="-fipa-profile -fprofile-reorder-functions -fvpt -fprofile-abs-path -fprofile-arcs -fauto-profile=/var/cpuminer $LDFLAGS"
